  ...
  <div class=login>
    <div class="login-cur">
      ...
      <el-form ref="ruleFormRef" :model="ruleForm" status-icon :rules="rules" label-width="120px" class="demo-ruleForm">
        ...
        <el-form-item>
          <el-button :disabled="loginbtnbool" class="login-btn" type="primary" @click="submitForm(ruleFormRef)">登录
          </el-button>
          <el-button :disabled="resetbtnbool" class="reset-btn" @click="resetForm(ruleFormRef)">重置</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
...
const submitForm = (formEl: FormInstance | undefined) => {
  ...
  formEl.validate((valid) => {
    if (valid) {
      // console.log('登录!')
      loginApi.loginUser({ username: ruleForm.username, password: ruleForm.password }).then((result: any) => {
        console.log(result);
